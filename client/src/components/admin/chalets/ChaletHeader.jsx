...
const ChaletHeader = ({ searchQuery, setSearchQuery, onAddClick }) => {
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        <div className="space-y-1.5">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-[700] text-white uppercase tracking-tight">
              {t('admin.chaletMgmt.title')}
            </h1>
          </div>
          <p className="text-[14px] font-[400] text-slate-400 pl-14">
            {t('admin.chaletMgmt.subtitle')}
          </p>
        </div>
        ...
        >
          ...
          <span className="relative z-10">{t('admin.addChalet')}</span>
      ...
      <div className="relative max-w-xl group">
        ...
        <input
          type="text"
          placeholder={t('admin.chaletMgmt.searchPlaceholder')}
